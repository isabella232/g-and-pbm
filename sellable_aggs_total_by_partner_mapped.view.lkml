view: sellable_aggs_total_by_partner_mapped {
  derived_table: {
    sql: WITH unique_pairs_by_cookie_domain AS (
      SELECT cookiedomain, total bucket, SUM(total_count) total_count
      ...
      SELECT
        ...
        COALESCE(SUM(unique_pairs_by_cookie_domain.total_count ), 0) AS "unique_pairs_by_cookie_domain.total"
