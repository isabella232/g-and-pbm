view: sellable_agg_detandhiacc_partner_mapped {
  derived_table: {
    sql: WITH unique_pairs_by_cookie_domain AS (
      SELECT cookiedomain, deterministicandhiaccprobabilistic bucket, SUM(deterministicandhiaccprobabilistic_count) deterministicandhiaccprobabilistic_count
      ...
      SELECT
        ...
        COALESCE(SUM(unique_pairs_by_cookie_domain.deterministicandhiaccprobabilistic_count ), 0) AS "unique_pairs_by_cookie_domain.deterministicandhiaccprobabilistic"
 ...
 ;;
  ...
  measure: unique_pairs_by_cookie_domain_deterministicandhiaccprobabilistic {
    type: sum
    sql: ${TABLE}."unique_pairs_by_cookie_domain.deterministicandhiaccprobabilistic" ;;
  }

  set: detail {
    fields: [bidder_sync_names_name, unique_pairs_by_cookie_domain_bucket, unique_pairs_by_cookie_domain_deterministicandhiaccprobabilistic]
  }
}
